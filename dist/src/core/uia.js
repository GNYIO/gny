    ...
    library.scheme.validate(query, {
        ...
        return (() => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const issues = yield app.sdb.find('Issuer', {}, limitAndOffset);
...
shared.getIssuerByAddress = (req, cb) => {
    ...
    return (() => __awaiter(this, void 0, void 0, function* () {
        try {
            const issues = yield app.sdb.find('Issuer', { address: req.params.address });
            if (!issuers || issuers.length === 0)
                return cb('Issuer not found');
...
shared.getIssuer = (req, cb) => {
    ...
    library.scheme.validate(query, {
        ...
        return (() => __awaiter(this, void 0, void 0, function* () {
            try {
                const issuers = yield app.sdb.find('Issuer', { name: req.params.name });
                if (!issuers || issuers.length === 0)
                    return cb('Issuer not found');
    ...
    library.scheme.validate(query, {
        ...
        return (() => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const assets = yield app.sdb.find('Asset', condition, limitAndOffset);
    ...
    library.scheme.validate(query, {
        ...
        return (() => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const assets = yield app.sdb.find('Asset', condition);
                if (!assets || assets.length === 0)
                    return cb('Asset not found');
    ...
    library.scheme.validate(query, {
        ...
        return (() => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const balances = yield app.sdb.find('Balance', condition, resultRange);
...
shared.getBalance = (req, cb) => {
    ...
    return (() => __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            let balances = yield app.sdb.find('Balance', condition);
            if (!balances || balances.length === 0)
                return cb('Balance info not found');
    ...
    return library.sequence.add((callback) => {
        (() => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield modules.transactions.processUnconfirmedTransactionAsync(trs);
