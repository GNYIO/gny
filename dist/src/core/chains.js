...
priv.get = (name, cb) => (() => __awaiter(this, void 0, void 0, function* () {
    try {
        const chain = yield priv.getChainByName(name);
        if (!chain)
...
priv.getByNames = (names, cb) => (() => __awaiter(this, void 0, void 0, function* () {
    try {
...
priv.launchApp = (chain, params, cb) => {
    const chainPath = path.join(priv.chainBaseDir, chain.name);
    const sandbox = new Sandbox(chainPath, chain.name, params, priv.apiHandler, true, library.logger);
...
priv.getChainByName = (name) => __awaiter(this, void 0, void 0, function* () {
    const chain = app.sdb.get('Chain', { name });
    return chain;
});
shared.getChain = (req, cb) => (() => __awaiter(this, void 0, void 0, function* () {
    try {
        let chain = yield priv.getChainByName(req.chain);
        if (!chain)
            return cb('Not found');
        chain = _.clone(chain);
        const delegates = yield app.sdb.findAll('ChainDelegate', { condition: { chain: req.chain } });
...
shared.getLastWithdrawal = (req, cb) => (() => __awaiter(this, void 0, void 0, function* () {
    try {
        const withdrawals = yield app.sdb.find('Withdrawal', { chain: req.chain }, 1, { seq: -1 });
...
shared.getDeposits = (req, cb) => (() => __awaiter(this, void 0, void 0, function* () {
    try {
        const deposits = yield app.sdb.loadMany('Deposit', { seq: { $gt: req.body.seq }, chain: req.chain }, 100);
