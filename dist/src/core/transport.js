...
priv.attachApi = () => {
    ...
    router.post('/commonBlock', (req, res) => {
        ...
        return (() => __awaiter(this, void 0, void 0, function* () {
            try {
                let blocks = yield app.sdb.getBlocksByHeightRange(min, max);
    ...
    router.post('/blocks', (req, res) => {
        ...
        return (() => __awaiter(this, void 0, void 0, function* () {
            try {
                const lastBlock = yield app.sdb.getBlockById(lastBlockId);
                if (!lastBlock)
                ...
                const blocks = yield modules.blocks.getBlocks(minHeight, maxHeight, true);
    ...
    router.post('/chainRequest', (req, res) => {
        ...
        return modules.chains.request(params.chain, body.method, body.path, { query: body.query }, (err, ret) => {
            if (!err && ret.error) {
                err = ret.error;
            }
            if (err) {
