...
module.exports = function (router) {
    router.get('/:address', function (req) {
        return __awaiter(_this, void 0, void 0, function () {
            var condition, account, unconfirmedAccount, lastBlock, ret;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, app.sdb.findOne('Account', { condition: condition })];
                    case 1:
                        account = _a.sent();
                        unconfirmedAccount = null;
                        if (!account)
                            return [3, 3];
                        return [4, app.sdb.load('Account', account.address)];
                    case 2:
