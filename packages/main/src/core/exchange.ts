...
export default class Exchange implements ICoreModule {
    ...
    (async () => {
      try {
        for (const transaction of transactions) {
          await Exchange.processUnconfirmedTransactionAsync(state, transaction);
        }
  ...
  public static processUnconfirmedTransactionAsync = async (
    ...
    try {
      ...
      await Exchange.applyUnconfirmedTransactionAsync(state, transaction);
