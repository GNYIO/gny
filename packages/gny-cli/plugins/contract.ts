  ...
  try {
    ...
    inquirer.prompt(
      ...
      function(result) {
        ...
        let exampleContract = fs.readFileSync(
        ...
        fs.writeFileSync(
          typesFile,
          'module.exports = ' + JSON.stringify(transactionTypes, null, 2),
          'utf8'
        );
        ...
        modules = JSON.stringify(modules, null, 2); // what false means?
...
export default function contract(program) {
  program
    .command('contract')
