...
export const MAX_PAYLOAD_LENGTH: number = 8 * 1024 * 1024;
...
export const REWARDS: IReward = {
  ...
  OFFSET: 1036800, // Start rewards after this offset
...
export const DELEGATE_VOTING_BUG_2_TESTNET_HEIGHT = 8_800_000;
