...
describe('delegate.js', () => {
  ...
  beforeEach(() => {
    ...
    keys = gnyJS.crypto.getKeys('secret');
    secondKeys = gnyJS.crypto.getKeys('secret 2');
  ...
  describe('#createDelegate', () => {
    ...
    describe('returned delegate', () => {
      ...
      it('should be signed correctly', () => {
        var result = gnyJS.crypto.verify(trs, keys.publicKey);
        result.should.be.ok;
      });

      it('should be second signed correctly', () => {
        var result = gnyJS.crypto.verifySecondSignature(
          trs,
      ...
      it('should not be second signed correctly now', () => {
        trs.amount = 100;
        var result = gnyJS.crypto.verify(trs, secondKeys.publicKey);
        result.should.be.not.ok;
      });
    });
  });
