...
describe('transaction.js', () => {
  var transaction = gnyJS.transaction;
  ...
  describe('#createTransaction', () => {
    ...
    describe('returned transaction', () => {
      ...
      it('should be signed correctly', () => {
        var result = gnyJS.crypto.verify(trs);
        result.should.be.ok;
      });
  ...
  describe('#createTransaction with second secret', () => {
    ...
    var keys = gnyJS.crypto.getKeys(secondSecret);
    ...
    describe('returned transaction', () => {
      ...
      it('should be second signed correctly', () => {
        var result = gnyJS.crypto.verifySecondSignature(trs, keys.publicKey);
        result.should.be.ok;
      });
