...
module.exports = function(dialect) {
  ...
  dialect.templates.add('queriesCombination', {
    ...
    validate: function(type, params) {
      ...
      templateChecks.propType(type, params, 'sort', [
        'string',
        'array',
        'object',
      ]);
  ...
  dialect.templates.add('joinItem', {
    ...
    validate: function(type, params) {
      ...
      templateChecks.atLeastOneOfProps('join', params, [
        'table',
        'query',
        'select',
        'expression',
      ]);
      templateChecks.onlyOneOfProps('join', params, [
        'table',
        'query',
        'select',
        'expression',
      ...
      templateChecks.propType('join', params, 'expression', [
        'string',
        'object',
      ]);
  ...
  dialect.templates.add('withItem', {
    ...
    validate: function(type, params) {
      ...
      templateChecks.atLeastOneOfProps('with', params, [
        'query',
        'select',
        'expression',
      ]);
      templateChecks.onlyOneOfProps('with', params, [
        'query',
        'select',
        'expression',
      ]);
      ...
      templateChecks.propType('with', params, 'expression', [
        'string',
        'object',
      ]);
    },
  ...
  dialect.templates.add('fromItem', {
    ...
    validate: function(type, params) {
      templateChecks.atLeastOneOfProps('from', params, [
        'table',
        'query',
        'select',
        'expression',
      ]);
      templateChecks.onlyOneOfProps('from', params, [
        'table',
        'query',
        'select',
        'expression',
      ...
      templateChecks.propType('from', params, 'expression', [
        'string',
        'object',
      ]);
  ...
  dialect.templates.add('select', {
    ...
    validate: function(type, params) {
      ...
      templateChecks.propType(type, params, 'from', [
        'string',
        'array',
        'object',
      ]);

      templateChecks.atLeastOneOfProps(type, params, [
        'table',
        'query',
        'select',
        'expression',
      ]);
      templateChecks.onlyOneOfProps(type, params, [
        'table',
        'query',
        'select',
        'expression',
